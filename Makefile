...
ifeq ($(USE_OPT),)
  USE_OPT = -O2 -fno-inline-small-functions -ggdb -fomit-frame-pointer -falign-functions=16 --specs=nano.specs -fstack-usage -ffast-math
endif
...
# setting.
CSRC = $(STARTUPSRC) $(KERNSRC) $(PORTSRC) $(OSALSRC) $(HALSRC) $(PLATFORMSRC) $(BOARDSRC) $(STREAMSSRC) \
       main.c usbcfg.c si5351.c tlv320aic3204.c dsp.c plot.c ui.c ili9341.c Font5x7.c flash.c adc.c lc_matching.c rtc.c ./FatFs/ff.c ./FatFs/ffunicode.c \
       arm_common_tables.c arm_sin_cos_f32.c
